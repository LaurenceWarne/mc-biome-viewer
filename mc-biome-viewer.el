...
(defcustom mc-biome-viewer-biome-to-face-map
  #s(hash-table test equal data ("ocean" '(foreground-color . "sky blue") "plains" '(foreground-color . "light green") "desert" '(foreground-color . "yellow") "extreme hills" '(foreground-color . "green") "forest" '(foreground-color . "green") "taiga" '(foreground-color . "dark green") "swampland" '(foreground-color . "brown") "river" '(foreground-color . "sky blue") "hell" '(foreground-color . "red") "the end" '(foreground-color . "white") "frozen ocean" '(foreground-color . "white") "frozen river" '(foreground-color . "white") "ice plains" '(foreground-color . "white") "ice mountains" '(foreground-color . "white") "mushroom island" '(foreground-color . "light pink") "mushroom island shore" '(foreground-color . "light pink") "beach" '(foreground-color . "gold") "desert hills" '(foreground-color . "yellow") "forest hills" '(foreground-color . "green") "taiga hills" '(foreground-color . "dark green") "extreme hills edge" '(foreground-color . "chocolate") "jungle" '(foreground-color . "spring green") "jungle hills" '(foreground-color . "spring green") "jungle edge" '(foreground-color . "spring green") "deep ocean" '(foreground-color . "dark blue") "stone beach" '(foreground-color . "grey") "cold beach" '(foreground-color . "white") "birch forest" '(foreground-color . "lawn green") "birch forest hills" '(foreground-color . "lawn green") "roofed forest" '(foreground-color . "green") "cold taiga" '(foreground-color . "white") "cold taiga hills" '(foreground-color . "white") "mega taiga" '(foreground-color . "olive") "mega taiga hills" '(foreground-color . "olive") "extreme hills+" '(foreground-color . "chocolate") "savanna" '(foreground-color . "orange") "savanna plateau" '(foreground-color . "orange") "mesa" '(foreground-color . "red") "mesa plateau f" '(foreground-color . "red") "mesa plateau" '(foreground-color . "red") "the end - floating islands" '(foreground-color . "white") "the end - medium island" '(foreground-color . "white") "the end - high island" '(foreground-color . "white") "the end - barren island" '(foreground-color . "white") "warm ocean" '(foreground-color . "cyan") "lukewarm ocean" '(foreground-color . "cyan") "cold ocean" '(foreground-color . "white") "warm deep ocean" '(foreground-color . "cyan") "lukewarm deep ocean" '(foreground-color . "cyan") "cold deep ocean" '(foreground-color . "white") "frozen deep ocean" '(foreground-color . "white") "the void" '(foreground-color . "white") "sunflower plains" '(foreground-color . "light green") "desert m" '(foreground-color . "yellow") "extreme hills m" '(foreground-color . "yellow") "flower forest" '(foreground-color . "light green") "taiga m" '(foreground-color . "dark green") "swampland m" '(foreground-color . "brown") "ice plains spikes" '(foreground-color . "violet") "jungle m" '(foreground-color . "spring green") "jungle edge m" '(foreground-color . "spring green") "birch forest m" '(foreground-color . "lawn green") "birch forest hills m" '(foreground-color . "lawn green") "roofed forest m" '(foreground-color . "green") "cold taiga m" '(foreground-color . "white") "mega spruce taiga" '(foreground-color . "white") "mega spruce taiga (hills)" '(foreground-color . "white") "extreme hills+ m" '(foreground-color . "chocolate") "savanna m" '(foreground-color . "orange") "savanna plateau m" '(foreground-color . "orange") "mesa (bryce)" '(foreground-color . "red") "mesa plateau f m" '(foreground-color . "red") "mesa plateau m" '(foreground-color . "red") "bamboo jungle" '(foreground-color . "spring green") "bamboo jungle hills" '(foreground-color . "spring green")))
